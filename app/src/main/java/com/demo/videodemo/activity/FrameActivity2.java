...
import com.demo.videodemo.codec.decoder.OutputImageFormat;
import com.demo.videodemo.codec.decoder.VideoToFrames;
import com.demo.videodemo.utils.FileUtils;

public class FrameActivity2 extends Activity implements VideoToFrames.Callback {
    private static final int REQUEST_CODE_GET_FILE_PATH = 1;
    private static final int PERMISSION_WRITE_EXTERNAL_STORAGE = 1;
    private OutputImageFormat outputImageFormat;
    private FrameActivity2 self = this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonFilePathInput.setOnClickListener(v -> {
            if (ContextCompat.checkSelfPermission(FrameActivity2.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(FrameActivity2.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSION_WRITE_EXTERNAL_STORAGE);
            } else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK) {
            ...
            String curFileName = FileUtils.getPath(this, data.getData());
